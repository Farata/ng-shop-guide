...
image::fig_03.png[Generate service command output,878,role="thumb"]
...
+
Remove the code added on this step into `AppComponent` since it won't be responsible for displaying products.
